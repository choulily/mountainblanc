...
COMMON_PATH := device/samsung/montblanc

TARGET_SPECIFIC_HEADER_PATH := $(COMMON_PATH)/include

BUILD_FINGERPRINT := samsung/montblanc3gctc/montblanc3gctc:4.3/JSS15J/W2014KEUBPI1:user/release-keys

# Audio
# TODO: find the right config
...
# Filesystem
# TODO: What the heck this file is about
TARGET_FS_CONFIG_GEN += $(COMMON_PATH)/config.fs

# HIDL
# Just grab the file untouched from hlte, should work
...
BOARD_MKBOOTIMG_ARGS := --ramdisk_offset 0x02000000 --tags_offset 0x01e00000 --kernel_offset 0x00008000 --second_offset 0x00f00000 --tags_offset 0x01e00000
BOARD_RAMDISK_USE_XZ := true
BOARD_CUSTOM_BOOTIMG := true
# TODO:
BOARD_CUSTOM_BOOTIMG_MK := hardware/samsung/mkbootimg.mk
TARGET_KERNEL_SOURCE := kernel/samsung/montblanc
